...
try {
    ...
    {
        CreateTable("test5", "id int, id2 int, id3 int, id4 int, id5 int, name text, name2 text, name3 text");     
    }

    if($command eq "Delete")
    {
        Delete("test5", "id=19900"); 
    }
    ...
    if($command eq "Select")
    {
        ...
        my $rows = Select("test5", "id=1", \&PrintRow);
    ...
    #Update("test5", "id=10003", "name3=Tzezo123123122");
    ...
    #InsertIntoTable("test5", "id=400001", "id2=5", "id3=3", "id4=4", "id5=5", "name=$one", "name2=$ten", "name3=$onehundred");
    ...
    if($command eq "Insert")
    {
        ...
        {    
            ...
            InsertIntoTable(undef, "test5", "id=$i", "id2=$z", "id3=3", "id4=4", "id5=5", "name=$one", "name2=$ten", "name3=$onehundred");
