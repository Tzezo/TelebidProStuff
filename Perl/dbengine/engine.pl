...
try {
    ...
    my $rows = Select("test4", "id=400001", \&PrintRow);
    ...
    #InsertIntoTable("test4", "id=400001", "id2=5", "id3=3", "id4=4", "id5=5", "name=$one", "name2=$ten", "name3=$onehundred");

    # for(my $i = 1; $i < 100000; $i++)
    # {    
    #     my $z = $i + 3;

    #     InsertIntoTable("test4", "id=$i", "id2=$z", "id3=3", "id4=4", "id5=5", "name=$one", "name2=$ten", "name3=$onehundred");
